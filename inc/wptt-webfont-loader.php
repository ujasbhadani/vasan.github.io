...
if ( ! class_exists( 'IT_Security_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class IT_Security_WPTT_WebFont_Loader {
		...
		public function get_remote_url_contents() {
			...
			$it_security_contents = wp_remote_retrieve_body( $response );

			return $it_security_contents;
		}
...
if ( ! function_exists( 'it_security_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function it_security_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new IT_Security_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'it_security_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function it_security_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new IT_Security_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
